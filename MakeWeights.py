...
np.save("ego2TransformationWts", ego2TransformationWts)
np.save("heading2TransformationWts", heading2TransformationWts)
np.save("transformation2BVCWts", transformation2BVCWts)
